...
path.cro <- "./HMM files_GPS_2013/Mar21_Crozet_Inc_GPS2010-16_all_RemIncSpFilLinInter_Wind_LoD_woShortTrips.csv"
...
cro.13 <- read.csv('./Created_databses_from_Full_script_data2013GPS_IS_modelR/gps_2013_ID.csv', stringsAsFactors=F)
...
GPS_ID_cones40_89 <- read.csv('./Created_databses_from_Full_script_data2013GPS_IS_modelR/GPS_ID_cones40_89.csv', stringsAsFactors=F)
