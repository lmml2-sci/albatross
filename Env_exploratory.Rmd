...
<!-- ```{r PDF trip , echo=FALSE, include = F} -->
<!-- # open PDF trip file -->
<!-- trip_name <- dir(path_to_ncdf, pattern = "PDF") -->
<!-- nc_file <- nc_open(paste0(path_to_ncdf, trip_name)) -->
<!-- print(nc_file) # getting all the characteristics of the file -->
<!-- #need to try to open and explore p_f and p_db -->
<!-- ``` -->
